...
try {
  ...
  $email_contact_received = infosite('email_contact_received');
  // Configuration option.
  // i.e. The standard subject will appear as, "You've been contacted by John Doe."
  // Example, $e_subject = '$name . ' has contacted you via Your Website.';
  $e_subject = _autoT('staff_new_message_from');
  $template_org = file_get_contents('templates/contact-us.php', true);
  $tags_in = [
    '%sitelogo%',
    '%sitename%',
    '%PreviewText%',
    '%staff_new_message_from%',
    '%staff_new_message_text%',
    '%name%',
    '%email%',
    '%phone%',
    '%subject%',
  ...
  $tags_out = [
    ...
    infosite('sitename'),
    infosite('sitedescr'),
    _autoT('staff_new_message_from'),
    _autoT('staff_new_message_text'),
    $name,
    $email,
    $phone,
    $subject,
